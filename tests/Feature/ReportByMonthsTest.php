...
class ReportByMonthsTest extends TestCase
{
    /**
    ...
    /**
     * Afirmar que de la función "obtener todos los meses que tienen información dos", por lo menos
     * hay un mes activo.
     *
     * @return void
     */
    public function test_confirm_that_from_the_get_all_months_that_have_information_two_function_at_least_one_month_is_active()
    {
        // Consultamos al usuario "Secretaria de distrito" con rol "Secretaria de distrito"
        $districSecretary = User::where('role_id', 3)->first();
        ...
        $response = $this->actingAs($districSecretary)->put('api/getAllTheMonthsThatHaveInformationDos/' . $fecha->year);
    ...
    /**
     * Afirmar que del método "getAllTheMonthsThatHaveInformationDos", solo puede entrar los usuarios
     * con rol "Secretaria de distrito".
     *
     * @return void
     */
    public function test_state_that_only_users_with_the_distric_secretary_role_can_access_the_getAllTheMonthsThatHaveInformationDos_method()
    {
        // Consultamos al usuario "Juan Carlos" con rol "Creadores del sistema"
        $systemCreators = User::where('role_id', 1)->first();
        ...
        $response = $this->actingAs($systemCreators)->put('api/getAllTheMonthsThatHaveInformationDos/' . $fecha->year);
        ...
        $response = $this->actingAs($churchSecretary)->put('api/getAllTheMonthsThatHaveInformationDos/' . $fecha->year);
