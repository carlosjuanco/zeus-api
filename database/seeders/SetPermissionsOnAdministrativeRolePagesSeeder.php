...
class SetPermissionsOnAdministrativeRolePagesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $roleOfAdministrative = Role::where('name', 'Administrativo')->first();

        $roleOfAdministrative->pages->each(function ($page) use ($permissions) {
